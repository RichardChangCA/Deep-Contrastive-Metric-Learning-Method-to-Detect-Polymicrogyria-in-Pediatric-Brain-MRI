...
def evaluation(test_images, test_labels):
    ...
    plt.hist(unseen_abnormal_dist, **kwargs, color='r', label='unseen anomaly')
    plt.gca().set(title='Metric loss testing data prediction', ylabel='Number of samples', xlabel='Prediction value')
    ...
    plt.plot(x, stats.kde.gaussian_kde(unseen_abnormal_dist)(x)*1000, 'r', linewidth=2)
