...
def train(train_images, train_labels, validation_images, validation_labels, epochs, BATCH_SIZE, nu):
...
train(train_images, train_labels, validation_images, validation_labels, epochs, BATCH_SIZE, nu)
