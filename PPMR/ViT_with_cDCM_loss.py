...
# code reference: https://keras.io/examples/vision/image_classification_with_vision_transformer/
...
projection_dim = 128 # 768 # 64
num_heads = 8 # 16 # 4
transformer_units = [
    projection_dim * 2,
    projection_dim,
]  # Size of the transformer layers
transformer_layers = 8 # 12 # 8
mlp_head_units = [2048, 1024] # [3072, 1024] # [2048, 1024]  # Size of the dense layers of the final classifier
...
def create_vit_classifier():
    ...
    # Classify outputs.
    output_representation = layers.Dense(latent_representation_dim)(features)
    # Create the Keras model.
    model = keras.Model(inputs=inputs, outputs=output_representation)
    return model

ViT_model = create_vit_classifier()
half_model = Sequential()
half_model.add(ViT_model)
...
def compute_loss(labels, z):
    ...
    euclidean_norm = tf.minimum(euclidean_norm, 20.) # 20 is the minimum distance to avoid NAN loss
    # print("euclidean_norm:", euclidean_norm)
