...
for i in range(4):
    ...
    patient_labels, patient_predictions, patient_dists = one_patient_evaluation(test_filepaths, test_labels)

    test_filepaths, test_labels, num_list = one_control_dataset_collection_func(i)
    control_labels, control_predictions, control_dists = one_patient_evaluation(test_filepaths, test_labels)
    ...
    plt.bar(np.arange(len(dists_concate)),dists_concate,color=color_list,width=1.)
    # specifying horizontal line type
    ...
    plt.axvline(x = len(patient_dists)+num_list[0]+num_list[1], color = 'black', linestyle = '-')

    plt.axvline(x = len(patient_dists)+num_list[0]+num_list[1]+num_list[2], color = 'black', linestyle = '-')
